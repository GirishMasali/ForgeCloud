...
resource "aws_iam_role" "eks_cluster" {
  ...
  description        = "IAM role for ForgeCloud EKS cluster control plane"
...
resource "aws_iam_role" "eks_nodes" {
  ...
  description        = "IAM role for ForgeCloud EKS managed worker nodes"
...
# ------------------------------------------------------------------------------
# GitHub Actions CI/CD IAM Role (Template for ECR push & deployment)
# ------------------------------------------------------------------------------
...
resource "aws_iam_role" "github_actions" {
  ...
  description        = "IAM role assumed by GitHub Actions for ForgeCloud CI/CD workflows"
...
resource "aws_iam_policy" "github_actions_ecr" {
  ...
  description = "Allows GitHub Actions CI/CD to push container images to ECR"
